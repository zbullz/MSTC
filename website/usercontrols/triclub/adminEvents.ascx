<%@ Control Inherits="cFront.Projects.CFSL.Web.UI.UserControls.AdminEvents" AutoEventWireup="true" Src="code/adminEvents.cs" %>
<asp:PlaceHolder id="containerEntry" runat="server" Visible="True" >
	...
	<p class="entry">
		<label>Event Date:<span class="entry_reqd">*</span></label><asp:TextBox id="txtLastName" runat="server" CssClass="txtbox" />
	...
	<p class="entry">
		...
		<asp:DropDownList id="ddlEventDistance" runat="server" CssClass="ddlbox">
			...
			<asp:ListItem Value="7" Text="10 mile"/>
			<asp:ListItem Value="8" Text="Half Marathon"/>
			<asp:ListItem Value="9" Text="Marathon"/>
			<asp:ListItem Value="10" Text="25 mile"/>
			<asp:ListItem Value="11" Text="50 mile"/>
			<asp:ListItem Value="12" Text="100 mile"/>
	...
	<p class="entry">
		<label>Photos:</label><asp:TextBox id="txtPhotosLink" runat="server" CssClass="txtboxw" />
	</p>
